...
This project has turned into [MudBun](http://longbunnylabs.com/mudbun/), a meshing-algorithm-based volumetric VFX mesh tool for Unity inspired by [Clayxels](https://assetstore.unity.com/packages/templates/systems/clayxels-165312).
