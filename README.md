...
This project has turned into [MudBun](http://longbunnylabs.com/mudbun/), a meshing-algorithm-based volumetric VFX tool for Unity inspired by [Clayxels](https://andrea-intg.itch.io/clayxels).
